        ...
        $("#calendar").evoCalendar('addCalendarEvent', [
            {
              ...
              badge: status,
              color: eventColor,
              description: '<h3 style="margin-top:0.1em;margin-bottom:0.5em;">' + event.name + "</h3>" + "Event Description: " + event.description + edit,
              everyYear: false
            }
          ]);
    });
