...
if (IS_DEVELOPMENT) {
    ...
    document.getElementById('signInWithRedirect').addEventListener('click', () => {
        beforeLogin();
        redirectLogin();
    });
    document.getElementById('signInAsClaire').addEventListener('click', () => {
        beforeLogin();
        devLogin(
            afterLogin,
    ...
    document.getElementById('signInAsAlex').addEventListener('click', () => {
        beforeLogin();
        devLogin(
            afterLogin,
